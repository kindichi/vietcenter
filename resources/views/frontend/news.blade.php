...
@section('content')
    ...
    <section class="container travelNews">
        <p><a href="">Trang chủ</a> > <a href="">Tin tức du lịch</a></p>
        ...
        <div class="travelnews-content">
            <div id="carouselExampleIndicators" class="carousel slide carousel-fade travelnews-slides" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item travelnews-slide active">
                        <div class="news-img">
                            <img src="/frontend/images/blog/mui dai lanh.jpg" alt="Biển Đại Lãnh, vẻ đẹp hoang sơ độc đáo của tỉnh Khánh Hòa">
                        </div>
                        <div class="news-content">
                            <p>
                                ...
                                <a href="" class="news-btn">Chi tiết</a>
                            </p>
                        </div>
                    </div>
                    <div class="carousel-item travelnews-slide">
                        <div class="news-img">
                            <img src="/frontend/images/blog/bien binh tien ninh thuan.jpg" alt="Khu du lịch Bình Tiên Ninh Thuận, vẻ đẹp hoang sơ">
                        </div>
                        <div class="news-content">
                            <p>
                                <a href="" class="news-title">
                    ...
                    <div class="carousel-item travelnews-slide">
                        <div class="news-img">
                            <img src="/frontend/images/blog/ong dia.jpg" alt="Khám phá bãi đá ông, địa điểm check in mới nổi tại Phan Thiết">
                        </div>
                        <div class="news-content">
                            <p>
                                <a href="" class="news-title">
                    ...
                    <div class="carousel-item travelnews-slide">
                        <div class="news-img">
                            <img src="/frontend/images/blog/bao-dung-passport-msquare-moi-3.jpg" alt="List 30 những vật dụng cần thiết khi đi du lịch bạn nên mang theo">
                        </div>
                        <div class="news-content">
                            <p>
                                <a href="" class="news-title">
                    ...
                    <div class="carousel-item travelnews-slide">
                        <div class="news-img">
                            <img src="/frontend/images/blog/combo du lich.jpg" alt="Tổng hợp những Combo du lịch dành tặng vợ hay cho người bạn gái lý tưởng của mình">
                        </div>
                        <div class="news-content">
                            <p>
                                <a href="" class="news-title">
            ...
            <div class="row new">
                ...
                <div class="news-static">
                    <div class="news-img">
                        <img src="/frontend/images/blog/at_le-hoi-phao-hoa-da-nang.jpg" alt="Các điểm bắn pháo hoa dịp Tết Nguyên Đán Canh Tý tại Hà Nội">
                    </div>
                    <div class="news-content">
                        <p>
                            <a href="" class="news-title">
                ...
                <div class="news-static">
                    <div class="news-img">
                        <img src="/frontend/images/blog/4Ky-Quan-Nui-Thung-P.jpg" alt="Khám phá thảo nguyên yên bình, xinh đẹp dưới chân núi Mắt Thần">
                    </div>
                    <div class="news-content">
                        <p><a href="" class="news-title">
