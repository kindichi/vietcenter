...
@section('content')
    <section class="content-header">
        <h1>
            Sửa thông tin Khách hàng <a href="{{route('admin.customer.index')}}" class="btn btn-primary">Danh sách </a>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.customer.update', ['id' => $data->id ])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dateStart" name="dateStart" value="{{$data->dateStart}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Ngày kết thúc</label>
                                    <input type="date" class="form-control" id="dateEnd" name="dateEnd" value="{{$data->dateEnd}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
