...
@section('content')
    <section class="content-header">
        <h1>
            Quản lý Đánh giá  <a href="{{ route('admin.review.create') }}" class="btn bg-purple btn-flat"><i class="fa fa-plus"></i> Thêm</a>
        </h1>
        <ol class="breadcrumb">
        ...
        $(document).ready(function() {
            ...
            $('.btn-delete').on('click',function () {
                ...
                if (result) { // neu nhấn == ok , sẽ send request ajax
                    $.ajax({
                        url: '/admin/review/'+id, // http://webthucpham.local:8888/user/8
