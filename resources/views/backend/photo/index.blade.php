...
@section('content')
    <section class="content-header">
        <h1>
            Quản lý Ảnh  <a href="{{ route('admin.photo.create') }}" class="btn bg-purple btn-flat"><i class="fa fa-plus"></i> Thêm</a>
        </h1>
        <ol class="breadcrumb">
                            ...
                            @foreach($data as $key => $item)
                                <tr class="item-{{ $item->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.photo.edit', ['id' => $item->id]) }}" class="btn btn-flat bg-purple"><i class="fa fa-pencil"></i></a>
        ...
        $(document).ready(function() {
            ...
            $('.btn-delete').on('click',function () {
                ...
                if (result) { // neu nhấn == ok , sẽ send request ajax
                    $.ajax({
                        url: '/admin/photo/'+id, // http://webthucpham.local:8888/user/8
