...
@section('content')
    <section class="content-header">
        <h1>
            Sửa Lịch trình <a href="{{route('admin.schedule.index')}}" class="btn btn-primary">Danh sách </a>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{route('admin.schedule.update', ['id' => $data->id ])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="box-body">
                        <div class="row">
